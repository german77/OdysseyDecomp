...
public:
    ...
    const sead::PtrArray<al::UniformBlock>* getViewIndexedUboArray(const char*) const;
    void setViewIndexedUboArray(const char*, const sead::PtrArray<al::UniformBlock>*);
    ...
    void initStageResource(const al::Resource*, const char*, const char*);
    void endInit();
    void initAfterPlacement();
    void initAfterCreateDrawTable();
    void setDrawEnv(s32, al::GBufferArray*, const sead::Camera*, const al::Projection*);
    void clearGraphicsRequest();
    void cancelLerp();
    void updateGraphics();
    void updatePartsGraphics(const al::GraphicsUpdateInfo&);
    void preDrawGraphics(SceneCameraInfo*);
    void calcGpuPartsGraphics(const al::GraphicsCalcGpuInfo&);
    void updateViewGpu(s32, const sead::Camera*, const al::Projection*);
    ...
    bool registPartsGraphics(al::PartsGraphics*);
    void drawSystemPartsGraphics(const al::GraphicsRenderInfo*) const;
    void doPartsGraphicsCommandBufferCopy(const al::GraphicsCopyInfo&) const;
    void doPartsGraphicsCompute(const al::GraphicsComputeInfo&) const;
    void drawPartsGraphics(const al::GraphicsRenderInfo&, const al::RenderVariables&) const;
    void drawPartsGraphicsGBufferAfterSky(const al::GraphicsRenderInfo&) const;
    void drawPartsGraphicsDeferred(const al::GraphicsRenderInfo&) const;
    void drawPartsGraphicsLdr(const al::GraphicsRenderInfo&) const;
    void drawPartsGraphicsIndirect(const al::GraphicsRenderInfo&, const al::RenderVariables&) const;
    void drawPartsGraphicsCubemap(const al::GraphicsRenderInfo&) const;
