...
void recordActorFront(IUseEventFlowData*, sead::Vector3f const&);
void checkInsideTerritoryPos(const IUseEventFlowData*, const LiveActor*, sead::Vector3f const&,
                             f32);
...
void checkInsideEmotionLowPriorityTerritoryPos(const IUseEventFlowData*, const LiveActor*,
                                               sead::Vector3f const&);
void checkInsideTalkTerritoryPos(const IUseEventFlowData*, const LiveActor*, sead::Vector3f const&);
void calcBalloonOffset(sead::Vector3f*, const IUseEventFlowData*, const LiveActor*);
void setBalloonLocalOffset(EventFlowExecutor*, sead::Vector3f const&);
