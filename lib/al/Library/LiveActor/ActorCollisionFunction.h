...
CollisionParts* getCollidedGroundCollisionParts(const LiveActor*);
CollisionParts* tryGetCollidedGroundCollisionParts(const LiveActor*);
CollisionParts* getCollidedWallCollisionParts(const LiveActor*);
CollisionParts* tryGetCollidedWallCollisionParts(const LiveActor*);
CollisionParts* getCollidedCeilingCollisionParts(const LiveActor*);
CollisionParts* tryGetCollidedCeilingCollisionParts(const LiveActor*);
