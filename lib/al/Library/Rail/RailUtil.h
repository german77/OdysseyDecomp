...
void moveRail(IUseRail* railHolder, f32);
...
void turnToRailDirImmediately(LiveActor* actor);
...
void calcNearestRailCoord(const IUseRail* railHolder, const sead::Vector3f&);
void calcNearestRailPos(sead::Vector3f*, const IUseRail* railHolder, const sead::Vector3f&);
...
void calcNearestRailPointPosCoord(const IUseRail* railHolder, const sead::Vector3f&);
void calcRailCoordByPoint(const IUseRail* railHolder, s32);
...
void tryGetCurrentRailPointArg(f32*, const IUseRail* railHolder, const char*);
void tryGetNextRailPointArg(f32*, const IUseRail* railHolder, const char*);
void tryGetCurrentRailPointArg(s32*, const IUseRail* railHolder, const char*);
void tryGetNextRailPointArg(s32*, const IUseRail* railHolder, const char*);
void tryGetCurrentRailPointArg(bool*, const IUseRail* railHolder, const char*);
void tryGetNextRailPointArg(bool*, const IUseRail* railHolder, const char*);
void tryGetCurrentRailPointArg(const char**, const IUseRail* railHolder, const char*);
void tryGetNextRailPointArg(const char**, const IUseRail* railHolder, const char*);
...
void calcRailPointNum(const IUseRail* railHolder, f32, f32);
void calcForwardRailPointNo(const IUseRail* railHolder, s32);
void calcPreviousRailPointNo(const IUseRail* railHolder, s32);
...
ModelGroup* createRailModelGroup(const IUseRail* railHolder, const ActorInitInfo&, const char*,
                                 const char*);
