...
SeDemoProcInfo::SeDemoProcInfo(const al::SeDemoProcInfo& info)
...
SeDemoSituationInfo::SeDemoSituationInfo(const al::SeDemoSituationInfo& demoSituationInfo)
...
SeDemoPauseInfo::SeDemoPauseInfo(const al::SeDemoPauseInfo& demoPauseInfo)
...
SeDemoStopOneShotInfo::SeDemoStopOneShotInfo(const al::SeDemoStopOneShotInfo& demoStopOneShotInfo)
...
SeDemoListenerPoserInfo::SeDemoListenerPoserInfo(
    const al::SeDemoListenerPoserInfo& demoListenerPoserInfo)
...
SeDemoPlaySeInfo::SeDemoPlaySeInfo(const al::SeDemoPlaySeInfo& demoPlaySeInfo)
