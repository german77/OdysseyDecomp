...
struct SeDemoProcInfo {
    ...
    SeDemoProcInfo();
    SeDemoProcInfo(const al::SeDemoProcInfo&);
...
struct SeDemoSituationInfo : public SeDemoProcInfo {
    ...
    SeDemoSituationInfo();
    SeDemoSituationInfo(const al::SeDemoSituationInfo& demoSituationInfo);
...
struct SeDemoPauseInfo : public SeDemoProcInfo {
    ...
    SeDemoPauseInfo();
    SeDemoPauseInfo(const al::SeDemoPauseInfo& demoPauseInfo);
...
struct SeDemoStopOneShotInfo : public SeDemoProcInfo {
    ...
    SeDemoStopOneShotInfo(const al::SeDemoStopOneShotInfo& demoStopOneShotInfo);
...
struct SeDemoListenerPoserInfo : public SeDemoProcInfo {
    ...
    SeDemoListenerPoserInfo(const al::SeDemoListenerPoserInfo& demoListenerPoserInfo);
...
struct SeDemoPlaySeInfo : public SeDemoProcInfo {
    ...
    SeDemoPlaySeInfo();
    SeDemoPlaySeInfo(const al::SeDemoPlaySeInfo& demoPlaySeInfo);
