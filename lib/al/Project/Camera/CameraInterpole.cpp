...
void CameraInterpole::start(const CameraTicket* ticket, f32 prevFovyDegree, s32 endInterpoleStep) {
    _48CamA.setPos(_118CamC.getPos());
    _48CamA.setAt(_118CamC.getAt());
    _48CamA.setUp(_118CamC.getUp());
    _48CamA.normalizeUp();
    ...
    if (endInterpoleStep >= 0) {
        ...
        f32 normalizedDistance =
            normalize((_118CamC.getPos() - ticket->getPoser()->getEye()).length(),
        ...
        s32 yDiffInterpoleSteps = yDiffDegrees < 0.75f ? 0 : (s32)(yDiffDegrees / 0.75f);
    ...
    if (mPrevTicket) {
        ...
        sead::Vector3f x = mPrevTicket->getPoser()->getEye() - mPrevTicket->getPoser()->getAt();
        sead::Vector3f v45 = ticket->getPoser()->getEye() - ticket->getPoser()->getAt();
        x.y = 0.0;
        v45.y = 0.0;
    ...
    if (isNear(_3c_at, mNextTicket->getPoser()->getAt(), 250.0f) ||
        (mNextTicket->getPoser()->getAt() - _3c_at)
                .dot(mNextTicket->getPoser()->getEye() - _30_pos) >= 0.0f)
...
void CameraInterpole::update(const sead::LookAtCamera& camera) {
    _178CamD.setPos(camera.getPos());
    _178CamD.setAt(camera.getAt());
    _178CamD.setUp(camera.getUp());
    _178CamD.normalizeUp();
    ...
    updateNerve();
    if (isActive() && isNear(_30_pos, _3c_at)) {
        _30_pos.set(_178CamD.getPos());
        _3c_at.set(_178CamD.getAt());
        _49_up.set(_178CamD.getUp());
        setNerve(this, &NrvCameraInterpole.Deactive);
    }
                ...
                for (s32 i = 0; i != 5; i++) {
                    ...
                    if (alCameraPoserFunction::checkFirstCameraCollisionArrow(
                        ...
                        if (!isNearZero(v51)) {
                            ...
                            // third: true;true
                            if (alCameraPoserFunction::checkFirstCameraCollisionArrow(
                                    &v50, nullptr, mNextTicket->getPoser(), _30_pos, v51) ||
                                alCameraPoserFunction::checkFirstCameraCollisionArrow(
                                    &v50, nullptr, mNextTicket->getPoser(), _30_pos + a1 * 10.0f,
                                    v51) ||
                                alCameraPoserFunction::checkFirstCameraCollisionArrow(
                                    &v50, nullptr, mNextTicket->getPoser(), _30_pos - a1 * 10.0f,
                                    v51)) {
    ...
    f32 v37 = lerpValue(_1f4, 1.0f, 0.3f);
...
void CameraInterpole::exeActiveHermite() {
    ...
    f32 v10 = getStep(mNextTicket->getPoser(), 1, mEndInterpoleStep);

    lerpVec(&_30_pos, _48CamA.getPos(), _178CamD.getPos(), v10);
    lerpVec(&_3c_at, _48CamA.getAt(), _178CamD.getAt(), v10);

    sub_something(&_49_up, _48CamA, _178CamD, _30_pos, _3c_at, v10);
...
void CameraInterpole::exeActiveHermiteDistanceHV() {
    ...
    f32 v9 = getStep(mNextTicket->getPoser(), 0, mEndInterpoleStep);
    f32 v16 = getStep(mNextTicket->getPoser(), 1, mEndInterpoleStep);
    ...
    lerpVec(&_3c_at, _48CamA.getAt(), _178CamD.getAt(), v16);

    sead::Vector3f x = _48CamA.getPos() - _48CamA.getAt();
    sead::Vector3f a1 = _178CamD.getPos() - _178CamD.getAt();
    ...
    sub_something(&_49_up, _48CamA, _178CamD, _30_pos, _3c_at, v16);
...
void CameraInterpole::exeActiveRotateAxisY() {
    ...
    sead::Vector3f a3 = _48CamA.getPos() - _48CamA.getAt();
    normalize(&a3);
    v47.set(a3);
    ...
    a3 = _178CamD.getPos() - _178CamD.getAt();
    normalize(&a3);
    v45.set(a3);
    ...
    f32 v28 =
        lerpValue((_48CamA.getPos() - _3c_at).length(), (_178CamD.getPos() - _3c_at).length(), v10);
...
void CameraInterpole::exeActiveBrigade() {
    updatePoser(&_48CamA);
    f32 v9 = getStepIn(1, mEndInterpoleStep);

    lerpVec(&_30_pos, _48CamA.getPos(), _178CamD.getPos(), v9);
    lerpVec(&_3c_at, _48CamA.getAt(), _178CamD.getAt(), v9);

    f32 v10 = calcAngleDegree(_48CamA.getUp(), _178CamD.getUp());
    if (isReverseDirection(_48CamA.getUp(), _178CamD.getUp(), 0.01f)) {
        sead::Vector3f v19 = {0.0f, 0.0f, 0.0f};
        calcDirVerticalAny(&v19, _48CamA.getUp());
        sead::Vector3f v17 = _48CamA.getUp();
        rotateVectorDegree(&v17, v17, v19, v9 * v10);
        _49_up.set(v17);
    } else {
        turnVecToVecDegree(&_49_up, _48CamA.getUp(), _178CamD.getUp(), v9 * v10);
    }
...
void CameraInterpole::updatePoser(sead::LookAtCamera* cam) {
    if (mPrevPoser) {
...
f32 CameraInterpole::getStep(CameraPoser* poser, s32 offset, s32 end) {
    f32 v7 = normalize(sead::Mathi::clampMin(getNerveStep(this) + offset, 1), 0, end);
...
f32 CameraInterpole::getStepIn(s32 offset, s32 end) {
    f32 v7 = normalize(sead::Mathi::clampMin(getNerveStep(this) + offset, 1), 0, end);
    return easeInOut(v7);
}
}  // namespace al
