...
public:
    ...
    ArchiveEntry* requestLoadArchive(const sead::SafeString& path, sead::Heap* heap,
                                     sead::FileDevice* device);
    bool loadSoundItem(u32 itemId, u32 unused, IAudioResourceLoader* loader);
    SoundItemEntry* requestLoadSoundItem(u32 itemId, u32 itemMiss, IAudioResourceLoader* loader);
