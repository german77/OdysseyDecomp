...
private:
    ...
    s32 mGroundTimeLimit = 0;
    s32 _154 = 0;
    s32 _158 = 0;
    al::JointRippleGenerator* mJointRippleGenerator = nullptr;
    sead::Vector3f joinRotator = sead::Vector3f::zero;
    ...
    bool _19c = true;
    bool _19d = false;
    sead::Matrix34f mSpawnPosition = sead::Matrix34f::ident;
    sead::Matrix34f mSwimSurfaceTraceEffectFollowMtx = sead::Matrix34f::ident;
    sead::Matrix34f mWaterAreaIn = sead::Matrix34f::ident;
    sead::Matrix34f mWaterAreaOutEffectFollowMtx = sead::Matrix34f::ident;
    sead::Matrix34f mWaterSurface = sead::Matrix34f::ident;
