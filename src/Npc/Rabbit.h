...
public:
    Rabbit(const char*, const al::Graph*, bool);
...
class RabbitGraph : public al::Graph {
public:
    const sead::Vector3f& getPosition() const { return mPosition; }

    bool getBool() const { return mPointers[530]; }
...
class RabbitGraphVertex : public al::Graph::Vertex {
public:
    const sead::Vector3f& getPosition() const { return mPosition; }

    bool getBool2() const { return mPointers[528]; }
...
class RabbitGraphEdge : public al::Graph::Edge {
public:
    u16 getValue() const { return mValues[282]; }
