...
public:
    ...
    void tryCalcTongueConnect(const al::CollisionParts**, sead::Vector3f*, sead::Vector3f*,
                              sead::Vector3f*, sead::Vector3f*) const;
    void getShrinkRestRange() const;
    void adjustShrinkRestRange(float);
    void exeStretch();
    void getTongueParamSpeed() const;
    void getTongueParamRange() const;
    void reactionCollideWall();
    void reactionCollideGround();
